...
from dapr.exps.passage_only.args.jinav2 import JinaV2PassageOnlyArguments
...
if __name__ == "__main__":
    ...
    RetrievedPassageIDList.dump_trec_csv(
        retrieval_results=retrieved, fpath=franked, system="jinav2"
    )
