...
from dapr.retrievers.dense import RetroMAE
from dapr.exps.passage_only.args.retromae import RetroMAEPassageOnlyArguments
...
if __name__ == "__main__":
    ...
    initialize_ddp()
    args = parse_cli(RetroMAEPassageOnlyArguments)
    if is_device_zero():
        args.dump_arguments()
