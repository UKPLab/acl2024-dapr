...
# nohup python -m dadpr.inference.bm25_summarized_context +dataset=nq +annotator=title experiment.wandb=True > bm25-nq-title.log&
# nohup python -m dadpr.inference.bm25_summarized_context +dataset=genomics +annotator=title experiment.wandb=True > bm25-genomics-title.log &
# nohup python -m dadpr.inference.bm25_summarized_context +dataset=msmarco +annotator=title experiment.wandb=True > bm25-msmarco-title.log &
