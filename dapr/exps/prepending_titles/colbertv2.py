...
from dapr.exps.prepending_titles.args.colbertv2 import (
    ColBERTv2PrependingTitlesArguments,
)
...
if __name__ == "__main__":
    ...
    initialize_ddp()
    args = parse_cli(ColBERTv2PrependingTitlesArguments)
    if is_device_zero():
        args.dump_arguments()
    ...
    RetrievedPassageIDList.dump_trec_csv(
        retrieval_results=retrieved, fpath=franked, system="colbertv2"
    )
